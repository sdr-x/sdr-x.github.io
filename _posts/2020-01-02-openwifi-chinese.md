...
* 我本人。两年多来几乎是120%的时间在投入。openwifi的的工作是这个欧盟H2020项目（ORCA）[https://www.orca-project.eu/](https://www.orca-project.eu/) 的一部分。主要动机是希望2020年项目结束时能给社区留下一些真正广为使用和流传的东西。当然也十分感谢公司[imec](https://www.imec-int.com/en/home)支持开源。
