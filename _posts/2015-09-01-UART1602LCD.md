...
For HACKRF P20 and P25 location and definition, you can refer to [hackrf-one-assembly.pdf]() and [hackrf-one-schematic.pdf]() in [original HACKRF github repo](https://github.com/mossmann/hackrf).
...
After some struggling in dark, I finally can present you quite simple code to output information via UART or 1602 LCD scree.

All you need are two files: []() and []()
...
A firmware hackrf_uart_1602lcd.dfu is also put into firmware/hackrf_uart_1602lcd/build/ of above repo in case someone want to try it in RAM via DFU mode without building firmware.
...
USE THIS compiler!!! --> https://launchpad.net/~terry.guo/+archive/ubuntu/gcc-arm-embedded
